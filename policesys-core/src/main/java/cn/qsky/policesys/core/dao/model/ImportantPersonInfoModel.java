...
public class ImportantPersonInfoModel {
  ...
  private List<PersonContactInfoModel> contacts;
  ...
  public List<PersonContactInfoModel> getContacts() {
    return contacts;
  }

  public void setContacts(List<PersonContactInfoModel> contacts) {
